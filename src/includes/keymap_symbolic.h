...
static uint8_t Keymap_SymbolicToStScanCode_FR(const SDL_Keysym* pKeySym) { (void)pKeySym; return ST_NO_SCANCODE; }
static uint8_t Keymap_SymbolicToStScanCode_UK(const SDL_Keysym* pKeySym) { (void)pKeySym; return ST_NO_SCANCODE; }
