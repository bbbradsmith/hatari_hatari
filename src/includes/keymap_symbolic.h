...
static uint8_t Keymap_SymbolicToStScanCode_US(const SDL_Keysym* pKeySym)
{
	...
	switch (pKeySym->sym)
	{
	 ...
	 case 161: code = 0x35; break; /* ¡¿ Spanish */
	 ...
	 case 241: code = 0x27; break; /* Ñ Spanish */
	 case 242: code = 0x29; break; /* (Is this SDL code correct?) Ç Spanish */
...
static uint8_t Keymap_SymbolicToStScanCode_ES(const SDL_Keysym* pKeySym)
{
	...
	switch (pKeySym->sym)
	{
	 ...
	 case SDLK_z: code = 0x2C; break;
	 case SDLK_DELETE: code = 0x53; break;
	 case 161: code = 0x35; break; /* ¡¿ mapped as § */
	 case 241: code = 0x27; break; /* Ñ */
	 case 242: code = 0x29; break; /* (Is this SDL code correct?) Ç */
	 case SDLK_KP_0: code = 0x70; break;
	 case SDLK_KP_1: code = 0x6D; break;
	 case SDLK_KP_2: code = 0x6E; break;
	 case SDLK_KP_3: code = 0x6F; break;
