...
static uint8_t Keymap_SymbolicToStScanCode_US(const SDL_Keysym* pKeySym)
{
	...
	switch (pKeySym->sym)
	{
	 ...
	 case 167: code = 0x2B; break; /* § SE as ST \ */
	 case 168: code = 0x1B; break; /* ¨ SE as ST ü */
